package class_lib.micrecorder.encoder
{
	import flash.events.Event;
	import flash.utils.ByteArray;
	import flash.utils.Endian;
	
	import class_lib.micrecorder.IEncoder;
	...
	public class WaveEncoder implements IEncoder
	{
		 ...
		 * 
		 */		
		public function encode( samples:ByteArray, channels:int, bits:int, rate:int):ByteArray
		{
			rate = 44100;
		...
		private function create( bytes:ByteArray ):ByteArray
		{
			...
			while( bytes.bytesAvailable ) 
				_buffer.writeShort( bytes.readFloat() * 32768 );
			return _buffer;
		}
	}
}